...
def get_excel_jobs_info(filename:str)->List[Dict]:
    ...
    for current_row in worksheet.rows:
        ...
        state_abbrev = usa_state_abbrev.us_state_abbrev[state_name]  # didn't need abbrev for sprint3 but it helps with 4
...
def demo_excel():
    results = get_excel_jobs_info("state_M2019_dl.xlsx")
    print(results[0])
